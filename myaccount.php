			...
			<span class="text2" id= 'findCars'>MY BOOKINGS</span>
				  <div class="my bookings">
				  	<?php
						...
						$innerTxt="<table><tr><th>Booking Id</th><th>Car No</th><th>Booking Date</th><th>Location</th><th>Status</th></tr>";
						if ($result->num_rows >= 1 )	
						{
							while($row = $result->fetch_assoc() ) 
							{
								$innerTxt=$innerTxt."<tr>";
								$innerTxt=$innerTxt. "<td>".$row["booking_id"]."</td><td>".$row["car_no"]."</td><td>".$row["booking_from_date"]."</td><td>".$row["booking_pickup_location"]."</td><td>".$row["booking_status"]."</td>";
