				...
				<?php
						...
						if ($result->num_rows >= 1)	
						{
							...
							while($row = $result->fetch_assoc()) 
							{
								...
								$innerText=$innerText."<h3 class=price1><b>Price:&nbsp;&nbsp;</b><span id=carprice".$count."  class=productPrice>$".$row['mfg_rate']."/Day  </span><span><button id=book-btn".$count." value=".$count." onclick=bookCar('".$count."')>Book </button></span></h3>";
